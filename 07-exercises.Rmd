...
3. [Optionally] If you want to generate pdf documents you should also install a Latex version: MikTeX for Windows or MacTeX on MacOS. If you want to keep things simple I suggest you stick to HTML and <MS Word output (Word can also export to PDF).

### Résumé

Create an R Markdown document called Résumé and create your Curriculum Vitae using Markdown syntax.
